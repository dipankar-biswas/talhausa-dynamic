                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Brand</button>
                        </h4>
                ...
                @foreach($brand as $data)
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure Delete?')" href="{{Route('brand.delete', $data->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
