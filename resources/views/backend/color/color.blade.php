                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add color</button>
                        </h4>
        ...
        <tbody>
            @if(isset($color) && $color != null)
                @foreach($color as $data)
                    <tr>
                        <td>{{$loop->index + 1}}</td>
                        <td><span class="color-box" style="background:{{$data->code}}"></span></td>
                        <td>{{$data->name}}</td>
                        <td>{{$data->private_name}}</td>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure Delete?')" href="{{Route('color.coldelete', $data->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" id="myForm">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" name="private_name" placeholder="Private Name">
                        <small id="errprivate_name" class="form-text"></small>
                    </div>

                    <div class="mb-3">
                        <input type="color" class="form-control" name="code" placeholder="Color Name or Color Code">
                        <small id="errcode" class="form-text"></small>
                    </div>
...
<!-- Update Modal Start-->
        <div class="modal fade modal-lg" id="staticBackdropUpdate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Update Color</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                ...
                <form method="post" id="myFormUpdate">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" name="private_name" id="private_name" placeholder="Private Name">
                        <small id="erruprivate_name" class="form-text"></small>
                    </div>
                    
                    <div class="mb-3">
                        <input type="color" class="form-control" name="code" id="code">
                        <small id="errucode" class="form-text"></small>
                    </div>
    ...
    $.ajax({
        ...
        success: function(response){
            if(response.status == "update"){
                ...
                $("#private_name").val(response.data.private_name);
