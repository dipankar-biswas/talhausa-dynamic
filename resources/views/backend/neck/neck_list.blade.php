...
<div class="layout-content">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Neck</button>
                        </h4>
    ...
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
            @if(isset($neck) && $neck != null)
                @foreach($neck as $data)
                    <tr>
                        <td>{{$loop->index + 1}}</td>
                        <td>{{$data->name}}</td>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure Delete?')" href="{{Route('neck.delete', $data->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Add Neck</h5>
              ...
              <div class="modal-body">
                ...
                <form method="post" id="myForm">
                    @csrf
                    <div class="mb-3">
                        <input type="text" class="form-control" name="name" placeholder="Neck name">
...
<!-- Update Modal Start-->
        <div class="modal fade modal-lg" id="staticBackdropUpdate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Update Neck</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                ...
                <form method="post" id="myFormUpdate">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" name="name" id="name" placeholder="Neck name">
                    ...
                    <div class="mb-3">
                        <div class="thumbnail">
                            <div class="image">
                                <div class="remove-btn ImageRemove">X</div>
                                <img class="imageDefault" src="{{ isset($setup->image)?asset($setup->header_logo):asset('backend/images/dummy-image.jpg') }}" alt="Thumbnail">
                                <img class="imagePreview" src="" alt="Thumbnail">
                            </div>
                            <button type="button" class="btn btn-border btn-sm imageSelect">Upload/Add image</button>
