...
<html>
	...
	<body>
		<table width="100%">
			<tr>
				<td>Dear {{$customerData->name}},</td>
			</tr>

			<tr>
				<td>Congratulation! your order placed successfully. <br>Your order Tacking ID is : <code>{{$customerData->trackingid}}</code> <br><br> You can check your order in our website. Please click Order Check button. <br> <br>
				Thanks By.
				<br>
					Development Team
				</td>
