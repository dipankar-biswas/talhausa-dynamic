...
@section('title','Product Search | Talha USA Online E-Commerce Business.')
                    ...
                    <div class="col-lg-9">
                        <div class="right-section">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="{{ $checkCat->slug }}" class="text-body text-hover">{{ $checkCat->name }}</a>
                                        </li>
                                        @endif
                            ...
                            <div class="heading d-flex justify-content-between align-items-center column-gap-3">
                                ...
                                <div class="sorting d-flex align-items-center column-gap-3">
                                    <div class="form-group">
                                        <label for="" class="ph-lg-none">Sort By</label>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="ph-lg-none">Brands</label>
                                        <select class="form-select form-select-sm" aria-label="Small select example">
